...
public class ServerFacade
{
    ...
    public UploadStatusResponse uploadStatus(UploadStatusRequest request) throws IOException, TweeterRemoteException
    {
        return null;
    }
    ...
    public GetNumFollowersResponse getNumFollowers(GetNumFollowersRequest request) throws IOException, TweeterRemoteException
    {
        return null;
    }

    public GetNumFollowingResponse getNumFollowing(GetNumFollowingRequest request) throws IOException, TweeterRemoteException
    {
        return null;
    }
