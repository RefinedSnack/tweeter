...
public class GetFeedTask extends PagedTask<Status>
{
    ...
    public GetFeedTask(AuthToken authToken, String targetUserAlias, int limit, Status lastStatus,
    ...
    {
        GetFeedRequest request = new GetFeedRequest(getAuthToken(), getTargetUserAlias(), getLimit(), getLastItem());
